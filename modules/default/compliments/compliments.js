...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["Näed vapustav välja!"],
			morning: ["Tere hommikust!", "Ära unusta naeratada!", "Mis hommikusöögiks plaanid teha?"],
			afternoon: ["Jaga teistega enda rõõme!", "Pool päeva läbitud, pool veel minna!"],
			evening: ["Kuidas tass teed kõlab?", "Ära muretse, hommik on õhtust targem!", "Oled täna hästi hakkama saanud!"],
